...
export const ADDO_MEDICATIONS_LIST: string[] = [
    "Aminophylline injection",
    "Amoxicillin capsules",
    "Amoxicillin oral suspension",
    "Annusol suppositories",
    "Bendrofluazide",
    "Benzyl Penicillin powder for injection",
    "Bisacodyl tablets",
    ...
    "Phenoxymethyl Penicillin suspension",
    "Phenoxymethyl Penicillin tablets",
    "Phenytoin",
    "Piperazine and its salts in oral dosage forms",
    ...
    "Acetylsalicylic acid/paracetamol/caffeine combinations",
    "Aluminium Hydroxide",
    "Arachis Oil preparations",
    "Ayuverdic ointments",
    "Benzocaine preparation (except for children)",
    "Camphor Preparations",
    "Carmellose preparations",
    "Chlorinate Lime (EUSOL) solution",
    "Clove oil",
    "Dental floss",
    "Dequalinium Prepartions",
    "Diclofenac ointment, cream or gel",
    "Eucalyptus",
    "Eucalyptus oil preparations",
    "Eucalyptus products",
    "Eugenol",
    "First Aid Ointment",
    "Gentian violet solution",
    "Ibuprofen and its salts ",
    "Ibuprofen/Ephedrine combinations",
    "Iodine solution",
    "Lozenges",
    "Magnesium trisillicate",
    "Menthol",
    "Menthol Products",
    "Mentholatum preparations",
    "Methyl salicylate products",
    "Mouth washes",
    "Oral Rehydration Salts (ORS)",
    "Paracetamol (in immediate release tablets, capsules or liquid)",
    "Products containing cough suppressants, antihistamines or decongestants except narcotic analgesics.",
    "Simethicone",
