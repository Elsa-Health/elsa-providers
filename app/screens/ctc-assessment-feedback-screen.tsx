...
import { Text, TextInput, RadioButton, Divider, Button, Checkbox, Card, Title, Paragraph } from 'react-native-paper'
  ...
  return (
    <Col md={12} colStyles={[{}]}>
      ...
      <Button
        ...
        uppercase={false}
      ><Text style={style.buttonText}>Complete</Text></Button>
    </Col>
  )
}
        ...
        <Card.Content>
          <Row>
            ...
            <Col md={12} colStyles={style.headerTextContentVerticalSpacing}>
              <Text style={[style.bodyContent, { color: "#7B7B7B", fontStyle: "italic" }]}>{subtitle} </Text>
            </Col>
...
const recommendationsDummy = [
  { title: "Referred to a laboratory for testing.", subtitle: "If yes, please indicate which tests you recommended: " },
  { title: "Dispensed medication to the patient.", subtitle: "If yes, please indicate which medication: " }
]
export const CtcAssessmentFeedbackScreen: React.FunctionComponent<CtcAssessmentFeedbackScreenProps> = observer((props) => {
  ...
  return (
    <Screen style={ROOT} preset="scroll" title="Assessment Feedback">
      <Row>
        ...
        <Col md={12}>
          <Text style={[style.contentHeader, style.contentTextVerticalSpacing]}>I provided the following recommendations: </Text>
        </Col>
        <Recommendation recommendation="Referred to nearest health facility." />
        <RecommendationWithSeach title={recommendationsDummy[0].title} subtitle={recommendationsDummy[0].subtitle} />
        <RecommendationWithSeach title={recommendationsDummy[1].title} subtitle={recommendationsDummy[1].subtitle} />
