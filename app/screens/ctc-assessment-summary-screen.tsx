  ...
  return (
    <>
      ...
      <Col md={12} colStyles={style.headerTextContentVerticalSpacing}>
        <Text style={[style.bodyContent, { fontStyle: "italic" }]}>Please indicate any new known conditions the patient has at the time of this visit: </Text>
      </Col>
      ...
      <Col md={12} colStyles={style.headerTextContentVerticalSpacing}>
        <Text style={[style.bodyContent, {}]}>
          It is most likely that your patient has <Text style={{ color: color.primary }}> Pneumocistis Pneumonia..</Text>
        </Text>
      </Col>
      <FullWidthDivider />
    </>
...
const RisksAssesmentCTC = ({ risk }) => {
  return (
    <>
      ...
      <Col md={12} colStyles={style.headerTextContentVerticalSpacing}>
        <Text style={[style.bodyContent, {}]}>
          {risk.riskMessage}   <Text style={{ color: color.primary }}> {risk.riskValue}</Text>
        </Text>
      </Col>
      ...
      <Col md={10} colStyles={style.headerTextContentVerticalSpacing}>
        <Text style={[style.bodyContent, { color: "#A8A8A8" }]}>
          {risk.warning}
        </Text>
      </Col>
      <FullWidthDivider />
...
const NextStepsCTC = ({ }) => {
  return (
    <>
      ...
      <Col md={12} colStyles={style.headerTextContentVerticalSpacing}>
        <Text style={[style.bodyContent, { fontStyle: "italic" }]}>Click on the next steps below to complete your visit with the patient.  </Text>
      </Col>
...
const riskyDummyData = [
  {
    title: "Risk of Non-Adherence", subtitle: "Based on our assessment, this shows the liklihood of non-adherence.",
    riskMessage: "The patient’s risk of non-adherence is",
    riskValue: "75%",
    warning: "Your patient does not understand their regimen and is sharing their medication with their family/ friends. Improving these will ensure that patient is more likely to adhere."
  },
  {
    title: "Drug Resistance Risk", subtitle: "Based on our assessment, this shows the liklihood of drug resistance.",
    riskMessage: "The patient’s risk of drug resistance is ",
    riskValue: "75%",
    warning: "It is not likely that your patient is experiencing HIV drug resistance. Please recommend they see a healthcare provider if they have any symptoms or side effects."
  },

]

export const CtcAssessmentSummaryScreen: React.FunctionComponent<CtcAssessmentSummaryScreenProps> = observer((props) => {
