...
import { useVisitStore } from "../../models/dispensary-store"
...
const PresentingSymptoms: React.FC = () => {
    ...
    const [presentingSymptoms, presentSymptoms, setState] = useVisitStore((state) => [
        ...
        <Screen preset="scroll" title="Patient Visit - Symptoms">
            ...
            <Row>
                <Col md={12} colStyles={{ flexDirection: "row-reverse" }}>
                    <Button
                        onPress={() => navigation.navigate("dispensary.SystemAssessment")}
                        label="Next"
                        labelSize="h6"
                        mode="contained"
