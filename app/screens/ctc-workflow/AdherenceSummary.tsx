...
const AdherenceSummary: React.FunctionComponent<AdherenceSummaryProps> = ({ route }) => {
...
// ALL DOWN COMPONENTS TO BE MOVED TO COMPONENTS FOLDER
...
const DiseaseAssesmentCTC = ({ diagnosesLikelihoods }) => {
    return (
        <Col md={12} marginVertical={15} paddingVertical={10}>
            ...
            <Text color="gray" size="h6" italic>
...
const NextScreenButton = () => {
    ...
    const { setIsPatientNew } = useRouteStore()
