...
// export interface AdherenceAssessProps {
            ...
            <Card marginVertical={20} title="Risk of Non-Adherence">
                ...
                <View style={{ marginVertical: 20 }}>
                    <Text size="h5" style={{ marginBottom: 6 }}>
                        How many times has the patient forgotten to take their medication in the
                        past month?
                    </Text>
                    <TextInput
                        label="Number"
                    ...
                    {/* <Button
                        ...
                        onPress={() => {
                            ...
                            if (mode === "medication-only") {
                                return navigation.navigate("ctc.AdherenceSummary", {
                                    ...props.route.params,
                                    adherence: false,
                                })
                            }
